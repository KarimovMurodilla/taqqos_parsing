...
#     'parse-test': {
#         'task': 'maxcom.product.category_parse',
#         'schedule': timedelta(minutes=1),
#     },

    # 'parse-maxcom-product': {
    #     'task': 'tasks.parse_maxcom_product',
    #     'schedule': timedelta(minutes=2),
    # },

    # 'parse-pcmarket-category': {
    #     'task': 'tasks.parse_pcmarket_category',
    #     'schedule': timedelta(minutes=1),
    # },
    # 'parse-pcmarket-product': {
    #     'task': 'tasks.parse_pcmarket_product',
    #     'schedule': timedelta(minutes=1),
    # },

    # 'parse-ikarvon-category': {
    #     'task': 'tasks.parse_ikarvon_category',
    #     'schedule': timedelta(hours=1),
    # },
    # 'parse-ikarvon-category': {
    #     'task': 'tasks.parse_ikarvon_product',
    #     'schedule': timedelta(hours=1),
    # },
